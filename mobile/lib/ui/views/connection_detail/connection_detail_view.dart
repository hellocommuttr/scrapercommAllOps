        ...
        child: ConstrainedBox(
          ...
          child: ListView(
            ...
            children: [
              ...
              if (connection.fare?.cashCents != null) ...[
                ...
                InfoBanner(
                  ...
                  message: connection.fare!.kind == 'per_leg'
                      ? 'About ${formatRands(connection.fare!.cashCents!)} in cash in total — you pay for each ride '
                            'separately. Last published fares; they may have changed.'
                      : '${formatRands(connection.fare!.cashCents!)} cash for the whole trip. '
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                              ...
                              '${leg.fare?.cashCents != null && connection.fare?.kind == 'per_leg' ? ' · ${formatRands(leg.fare!.cashCents!)} cash' : ''}',
              ...
              FilledButton.icon(
                ...
                label: Text(viewModel.added ? 'Both rides are on your planner' : 'Add both rides to planner'),
              ),
            ],
          ),
        ),
